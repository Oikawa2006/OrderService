...
public class UserRepositoryTest {
    ...
    public void givenSavedUser_whenUpdateUser_thenUserIsUpdated() {
        ...
        User UserToSave = DataUtilUser.getUserDanil();
    ...
    public void givenThreeSavedUsers_whenFindAll_thenUsersIsReturned() {
        //given
        User userToSave1 = DataUtilUser.getUserDanil();
        User userToSave2 = DataUtilUser.getUserOleg();
        User userToSave3 = DataUtilUser.getUserDima();
